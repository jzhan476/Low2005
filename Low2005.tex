...
uncertain and markets are incomplete. The paper's central point is that labour
...
under flexible versus fixed labour supply. The simulation uses a fixed random seed and
...
\citet{French2004Low}, which also benefits from modelling labour supply jointly with savings
decisions.
