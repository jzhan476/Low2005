...
under flexible versus fixed labor supply. The simulation uses a fixed random seed and
HARK's \texttt{LaborIntMargConsumerType} and \texttt{IndShockConsumerType} for the
flexible-hours and fixed-hours economies, respectively. Retirement (ages~65--84) is
