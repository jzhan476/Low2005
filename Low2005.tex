...
Low (2005) sits at the intersection of three literatures, and the cleanest way
to understand its contribution is to place it relative to each of them.

\paragraph{Incomplete-markets foundations and precautionary saving.}
The household problem is a Bewley-style economy with uninsurable idiosyncratic
risk in the tradition of \citet{Huggett1993Low} and \citet{Aiyagari1994Low}.
The precautionary-savings mechanism that drives household behavior in such
models was formalized by \citet{Kimball1990Low}, who characterized prudence
and the resulting demand for buffer wealth in both small and large risks.
\citet{Carroll1997Low} sharpened this into the buffer-stock interpretation of
life-cycle consumption that is now standard, and \citet{CarrollSamwick1997Low}
documented empirically that households facing higher income variance hold
significantly more wealth. Within this tradition, the strand most directly
parallel to Low (2005) is \citet{Cagetti2003Low}, who likewise estimates a
life-cycle precautionary-saving model but holds hours fixed, and
\citet{GourinchasParker2002Low}, who jointly estimate the buffer-stock and
life-cycle motives over the working life.

\paragraph{Life-cycle labor supply with risk.}
Low's distinctive contribution is to add a flexible labor-supply margin to
this framework. The closest contemporaneous work is \citet{PijoanMas2006Low},
who poses essentially the same question --- ``precautionary saving or working
longer hours?'' --- and confirms that flexible hours partially substitute for
asset-based self-insurance. \citet{ImaiKeane2004Low} embed life-cycle labor
supply in a model with on-the-job human-capital accumulation and find that
this dramatically raises implied intertemporal substitution. From a different
angle, \citet{DomeijFloden2006Low} show that ignoring borrowing constraints
biases standard estimates of the labor-supply elasticity downward, and
\citet{ErosaFusterKambourov2016Low} provide a quantitative micro-founded
theory of aggregate hours that emphasizes the interaction of intensive and
extensive margins. Together, this work motivates --- and to a substantial
extent vindicates --- the labor-supply margin that Low models.

\paragraph{Empirical magnitudes and modern context.}
The wage process in Low (2005) is parameterized using estimates from
\citet{MeghirPistaferri2004Low}, and the broader empirical patterns of
life-cycle wage inequality that the calibration aims to match are documented
by \citet{HeathcoteStoreslettenViolante2010Low}. The Frisch elasticity that
governs the labor-supply response to shocks remains contested; the synthesis
in \citet{Chetty2012Low} reconciles much of the gap between micro and macro
estimates by allowing for optimization frictions. More recent
heterogeneous-agent New Keynesian work, such as \citet{KaplanMollViolante2018Low},
inherits the incomplete-markets infrastructure but typically holds labor
supply fixed; in this sense Low's labor-supply self-insurance margin remains
an underexplored channel in the modern HANK literature, with related but
fixed-hours analyses found in \citet{Deaton1991Low} and \citet{French2004Low}.
...
mean hours and peak-assets age are within roughly 10\% of the published
calibration, with the slight underprediction of mean hours and the
five-year-earlier peak driven by ingredients of Low~(2005) that are
deliberately \emph{not} added here (no mortality risk during retirement,
